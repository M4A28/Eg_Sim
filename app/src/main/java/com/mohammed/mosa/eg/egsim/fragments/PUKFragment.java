...
import com.mohammed.mosa.eg.egsim.databinding.FragmentPUKBinding;


public class PUKFragment extends DialogFragment {

    private static final String ARG_COM = "com";
    private static final String ARG_USSD = "ussd";
    FragmentPUKBinding binding;
    ...
    public static PUKFragment newInstance(String com, String ussd) {
        PUKFragment fragment = new PUKFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        binding = FragmentPUKBinding.inflate(getActivity().getLayoutInflater());
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        alert.setTitle("رمز PUK").setView(binding.getRoot());
        return alert.create();
    }
    ...
    private void customPUKFragment(int dark, int light){
